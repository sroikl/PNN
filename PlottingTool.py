...
import itertools
def PlotResults():
    LoadPath= f'{os.getcwd()}/Results23.pt'
    ...
    true_labels= saved_results1['true_labels'] ; predicted_output= saved_results1['predicted_output']
    ...
    predicted_output= list(itertools.chain(*predicted_output))
    ...
    plt.plot(predicted_output,label='pred')
    plt.legend()
