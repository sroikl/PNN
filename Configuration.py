...
exp_args= dict(num_epochs= 500, lr= 1e-4, embedding_dim= 128,tcn_num_levels= 5, tcn_hidden_channels= 1024,
           tcn_kernel_size=3 ,tcn_dropout= 0.3,TimeWindow= 8,batch_size=16, start_date = '2020-03-04-00-00-00', end_date= '2020-03-28-19-55-00')

line_dict= {'exp3':{'line1':['lys_7','lys_13','3s_20','lys_22','lys_28'],'line2':['lys_4','lys_12','lys_14','lys_23','lys_30'],
